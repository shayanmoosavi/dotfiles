...
-- MainMod key
local mainMod = require("hypr.modules.keybinds.defaults").MainMod
...
for direction, properties in pairs(move_properties) do
    -- Swap active window
    hl.bind(mainMod .. " + " .. properties.move_bind_key, hl.dsp.window.swap(properties.action), {
        description = "Swap active window " .. '(' .. direction .. ')'
    })

    -- Move focus
    hl.bind(mainMod .. " + " .. properties.focus_bind_key, hl.dsp.focus(properties.action), {
