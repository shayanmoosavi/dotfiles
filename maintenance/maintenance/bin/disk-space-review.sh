...
ACTUAL_SCRIPT="$SCRIPT_DIR/../system/disk-space.sh"
...
main() {
    echo ""
    echo "╔════════════════════════════════════════════════════════════════╗"
    echo "║                  Disk Space Review & Analysis                  ║"
    echo "╚════════════════════════════════════════════════════════════════╝"
    echo ""

    # Execute the review
    if review_disk_space; then
        echo ""
        print_success "Disk space review completed!"
        echo ""
        ...
        local exit_code=$?
        echo ""
        print_error "Disk space review failed!"
        echo ""
        print_info "Log saved to: $(get_log_file)"
        echo ""
        exit $exit_code
